...
> **口径注记 (2026-08-13)**: 本报告正文数字为当时弱头协议 (lr=5e-4/40ep) 结果。
> 已用**规范头协议 (lr=1e-3/80ep)** 重跑下游 LOOCV：非PP4 逐折均值 **0.487**（弱头 0.485），
> pooled **0.478**；结论不变（仍远低于规范 baseline 0.579±0.007）。README/汇总表以规范头数字为准。
